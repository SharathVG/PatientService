package com.myorg.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.myorg.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.myorg.springboot.model" });
